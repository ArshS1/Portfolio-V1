...
document.getElementById("imageContainer").addEventListener("mouseleave", () => 
    document.getElementById("description").style.opacity = "0"
);

// project 2 animation
document.getElementById("imageContainer2").addEventListener("mouseover", () => 
    document.getElementById("description2").style.opacity = "1"
);
document.getElementById("imageContainer2").addEventListener("mouseleave", () => 
...
function saveInformation(name, email, message) {
    ...
    if (name !== "" && email !== "" && message !=="") {
        ...
        document.getElementById("messageData").innerHTML = "*Please fill out the form completely*";
        document.getElementById("messageData").style.opacity = "1";
    }
};
